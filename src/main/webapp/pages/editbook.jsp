...
<html>
    ...
    <body>
        ...
        <div class="off-canvas-wrap" data-offcanvas> 
            ...
            <form:form method="post" action="/editbook" commandName="book">
                ...
                <tr>
                    ...
                    <td><form:input path="yearPublished" value="${book.yearPublished}"/>
                ...
                <tr>
                    ...
                    <td>
                        <form:checkboxes path="categoryList" items="${categoryList}" itemLabel="categoryName" itemValue="categoryName" />
